...
from app.services import BookingConflictError, BookingValidationError, UserNotFoundError
...
def test_booking_service_rejects_unknown_user(booking_service, base_now):
